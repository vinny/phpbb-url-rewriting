...
$lang = array_merge($lang, array(
    ...
    'ACP_URLREWRITING_FAQ_FEATURE_URLS'     => 'URLs amigáveis: substitui links com parâmetros por URLs limpas e legíveis.',
    'ACP_URLREWRITING_FAQ_FEATURE_TRANSLIT' => 'Transliteração: remove acentos e caracteres especiais para gerar slugs ASCII.',
    'ACP_URLREWRITING_FAQ_FEATURE_REDIRECTS'=> 'Redirecionamentos 301: encaminha URLs antigas para as novas URLs amigáveis.',
    'ACP_URLREWRITING_FAQ_FEATURE_SITEMAP'  => 'Sitemap XML: gera uma lista de fóruns e tópicos públicos para mecanismos de busca.',
    'ACP_URLREWRITING_FAQ_FEATURE_OPENGRAPH'=> 'Open Graph: adiciona metadados para melhorar o compartilhamento em redes sociais.',
    ...
    'ACP_URLREWRITING_FAQ_SERVER_STEP_1'    => 'Escolha o modo de URL em Configurações.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_2'    => 'Abra o módulo Configuração do servidor e selecione Apache ou NGINX.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_3'    => 'Copie o bloco correspondente e cole no arquivo de configuração do servidor.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_4'    => 'Limpe o cache do phpBB e teste links de fórum, tópico, post e sitemap.xml.',
