...
$lang = array_merge($lang, array(
    ...
    'ACP_URLREWRITING_FAQ_FEATURE_URLS'     => 'Friendly URLs: replaces parameter-based links with clean, readable URLs.',
    'ACP_URLREWRITING_FAQ_FEATURE_TRANSLIT' => 'Transliteration: removes accents and special characters to generate ASCII slugs.',
    'ACP_URLREWRITING_FAQ_FEATURE_REDIRECTS'=> '301 redirects: forwards old URLs to the new friendly URLs.',
    'ACP_URLREWRITING_FAQ_FEATURE_SITEMAP'  => 'XML sitemap: generates a list of public forums and topics for search engines.',
    'ACP_URLREWRITING_FAQ_FEATURE_OPENGRAPH'=> 'Open Graph: adds metadata to improve link previews on social networks.',
    ...
    'ACP_URLREWRITING_FAQ_SERVER_STEP_1'    => 'Choose the URL mode in Settings.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_2'    => 'Open the Server Configuration module and select Apache or NGINX.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_3'    => 'Copy the matching block and paste it into your web server configuration file.',
    'ACP_URLREWRITING_FAQ_SERVER_STEP_4'    => 'Purge the phpBB cache and test forum, topic, post, and sitemap.xml links.',
